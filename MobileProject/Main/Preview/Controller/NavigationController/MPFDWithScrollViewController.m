//
//  MPFDWithScrollViewController.m
//  MobileProject
//
...
#import "MPFDWithScrollViewController.h"

@interface MPFDWithScrollViewController ()

@end

@implementation MPFDWithScrollViewController
...
{
    return [self changeTitle:@"带有左右滚动的页面"];
}
