...
#import "MPFDWithBarViewController.h"

@interface MPFDWithBarViewController ()

@end

@implementation MPFDWithBarViewController
...
{
    return [self changeTitle:@"有导航栏的页面"];
}
